    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-5 sm:space-y-6 md:space-y-8">
        <div className="space-y-2 md:space-y-4">
          {isLoading ?
            <div className="flex flex-row items-center gap-3 md:gap-5 w-full animate-pulse">
              {/* Icon Placeholder */}
              <div className="flex-shrink-0 p-2 md:p-3 rounded-lg bg-gray-200"></div>

              {/* Text Placeholder */}
              <div className="flex-1 min-w-0 space-y-1">
                <div className="h-6 sm:h-8 md:h-10 lg:h-12 w-3/4 bg-gray-200 rounded"></div>
                <div className="h-3 sm:h-4 md:h-4 w-1/2 bg-gray-200 rounded"></div>
              </div>
            </div>
            :
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-4 sm:gap-5 md:gap-6 lg:gap-6">
          ...
          {isLoading ?
            <div className="lg:col-span-1 rounded-xl sm:rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300 animate-pulse">
              <div className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6">
                ...
                <div className="relative w-full overflow-hidden">
                  {/* Top Stripe / Banner */}
                  <div className="h-32 md:h-44 w-full bg-gray-200 rounded" />

                  {/* Profile Image – LEFT (Circle) */}
                  <div className="absolute left-6 md:left-8 top-20 md:top-28">
                    <div className="relative">
                      <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full border-4 border-white bg-gray-200 flex items-center justify-center"></div>
                      <div className="absolute bottom-1 right-1 w-8 h-8 md:w-10 md:h-10 rounded-full bg-gray-300 border border-white"></div>
                    </div>
                  </div>
                ...
                <div className="space-y-2.5 sm:space-y-3 md:space-y-4">
                  <div className="h-10 sm:h-11 w-full bg-gray-200 rounded"></div>
                  <div className="flex items-center gap-2 p-2.5 sm:p-3 md:p-4 rounded-lg bg-gray-200">
            ...
            <div className="lg:col-span-1 rounded-xl sm:rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300 animate-pulse">
              <div className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6">
                ...
                <div className="space-y-2.5 sm:space-y-3 md:space-y-4">
                  ...
                  {/* Contact Information */}
                  <div className="pt-2 sm:pt-3 md:pt-4 border-t border-gray-200 space-y-2 sm:space-y-2.5 md:space-y-3">
                    <div className="h-10 sm:h-11 w-full bg-gray-200 rounded flex items-center px-4"></div>
                    <div className="h-10 sm:h-11 w-full bg-gray-200 rounded flex items-center px-4"></div>
                  </div>
                </div>
              </div>
          ...
          {isLoading ? 
          <div className="w-full rounded-xl sm:rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300 animate-pulse">
            <div className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6">

              {/* Header */}
              <div className="flex items-center gap-2 sm:gap-3 pb-3 border-b border-gray-200">
                <div className="p-2 rounded-lg bg-gray-200"></div>
                <div className="h-5 sm:h-6 w-40 sm:w-48 bg-gray-200 rounded"></div>
              </div>

              <div className="space-y-3">
                {/* Days Open */}
                <div className="h-10 sm:h-11 w-full bg-gray-200 rounded flex items-center px-3"></div>

                {/* Opening & Closing Time */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="h-24 sm:h-28 w-full bg-gray-200 rounded flex flex-col items-center justify-center space-y-1"></div>
                  <div className="h-24 sm:h-28 w-full bg-gray-200 rounded flex flex-col items-center justify-center space-y-1"></div>
                </div>
              ...
              <div className="pt-3 border-t border-gray-200">
                <div className="h-10 sm:h-11 w-full bg-gray-200 rounded flex items-center justify-center gap-2 px-3"></div>
              </div>
            </div>
          </div>
            :
